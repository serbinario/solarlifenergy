...
Route::any('/report/{id}/os', 'ReportController@reportOs')->name('reportOs');
...
Route::group(
    ...
    Route::post('/pago','Financeiro\ContasPagarReceberController@updatePago')
        ->name('financeiro.updatePago');
