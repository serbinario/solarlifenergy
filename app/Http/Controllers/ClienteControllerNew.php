...
class ClienteController extends Controller
{
    ...
    public function grid(Request $request)
    {
        ...
        $rows = \DB::table('clientes')
            ...
            ->leftjoin('clientes_users', 'clientes.id', '=', 'clientes_users.cliente_id')
            ->leftjoin('users', 'users.id', '=', 'clientes_users.user_id')
            ...
            ->select([
                ...
                \DB::raw('GROUP_CONCAT(users.name) as integrador')
            ]);
