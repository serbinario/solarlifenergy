...
class OsInstalacaoController extends Controller
{
    use UtilFiles;
    private $token;
    ...
    public function index()
    {
        ...
        return view('execucao.os_instalacao.index', compact('status'));
    }
    ...
    public function edit($id)
    {
        ...
        $status = StatusVisita::pluck('descricao','id')->all();
        //dd($ordemServico);
        return view('execucao.os_instalacao.edit', compact( 'ordemServico', 'users', 'status'));
