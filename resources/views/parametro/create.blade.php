...
<!-- BEGIN HORIZONTAL FORM -->
    <div class="row">
        <div class="col-lg-12">
            <form method="POST" action="{{ route('parametro.parametro.store') }}" accept-charset="UTF-8" id="create_parametro_form" name="create_parametro_form" class="form-horizontal">
                <div class="card">
                    <div class="card-head style-primary">
                        <header>Novo Parâmetro</header>
                        <div class="tools">
                            <div class="btn-group">
                    ...
                    {{ csrf_field() }}
                    @include ('parametro.form', [ 'parametro' => null,   ])
