...
<!-- BEGIN HORIZONTAL FORM -->
    <div class="row">
        <div class="col-lg-12">
            <form method="POST" action="{{ route('proposta.expansao.store') }}" accept-charset="UTF-8" id="create_pre_proposta_form" name="create_pre_proposta_form" onsubmit="return validateForm()" class="form-horizontal">
                <div class="card">
                    <div class="card-head style-primary">
                        <header>Nova Proposta</header>
                        <div class="tools">
                            <div class="btn-group">
                                <a href="{{ route('proposta.expansao.index') }}" class="btn btn-primary" title="Show All Pre Proposta">
                    ...
                    {{ csrf_field() }}
                    @include ('pre_proposta_expansao.form_create', [ 'preProposta' => null,   ])

                    <div class="card-actionbar">
                        <div class="card-actionbar-row">
                            <button id="simular" type="button" class="btn btn-flat btn-primary ink-reaction">Simular</button>
                            <a href="{{ route('proposta.expansao.index') }}" type="button" class="btn btn-flat btn-primary ink-reaction">Voltar</a>
...
@section('javascript')
    ...
    <script src="{{ asset('/js/pre_proposta_expansao/create.js')}}" type="text/javascript"></script>
