...
@section('content')
    ...
    <!-- BEGIN HORIZONTAL FORM -->
        <div class="row">
            <div class="col-lg-12">
                <form method="POST" action="{{ route('alert.update', $alert->id) }}" accept-charset="UTF-8" id="edit_franquia_form" name="edit_franquia_form" class="form-horizontal">
                    ...
                    <div class="card">
                        ...
                        @include ('alert.form', ['alert' => $alert, ])
