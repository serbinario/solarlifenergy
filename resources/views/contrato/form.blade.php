...
<div class="form-group {{ $errors->has('projeto_id') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <select class="form-control input-sm" id="projeto_id" name="projeto_id" required="true">
...
<div class="form-group {{ $errors->has('ano') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control input-sm" name="ano" type="text" id="ano" value="{{ old('ano', isset($contrato->ano) ? $contrato->ano : null) }}" maxlength="4" placeholder="Enter ano here...">
    ...
    <div class="form-group {{ $errors->has('report_layout_id') ? 'has-error' : '' }}">
        ...
        <div class="col-md-10">
            <select class="form-control input-sm" id="report_layout_id" name="report_layout_id" required="true">
