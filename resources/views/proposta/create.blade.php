...
<!-- BEGIN HORIZONTAL FORM -->
    <div class="row">
        <div class="col-lg-12">
            <form method="POST" action="{{ route('proposta.store') }}" accept-charset="UTF-8" id="create_proposta_form" name="create_proposta_form" onsubmit="return validateForm()" class="form-horizontal">
                <div class="card">
                    <div class="card-head style-primary">
                        <header> Proposta</header>
                        <div class="tools">
                            <div class="btn-group">
                                <a href="{{ route('proposta.index') }}" class="btn btn-primary" title="Show All Pre Proposta">
                    ...
                    {{ csrf_field() }}
                    @include ('proposta.form', [ 'proposta' => null,   ])

                    <div class="card-actionbar">
                        <div class="card-actionbar-row">
                            <a href="{{ route('proposta.index') }}" type="button" class="btn btn-flat btn-primary ink-reaction">Voltar</a>
