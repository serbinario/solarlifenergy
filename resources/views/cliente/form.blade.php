<div class="card-body">
    ...
    <div class="form-group {{ $errors->has('rg') ? 'has-error' : '' }}">
        <label for="data_emissao_rg" class="col-md-2 control-label">Data Emissão</label>
        <div class="col-md-10">
    ...
    <div class="form-group {{ $errors->has('orgao_emissor_rg') ? 'has-error' : '' }}">
        <label for="orgao_emissor_rg" class="col-md-2 control-label">Orgão Emissor</label>
        <div class="col-md-10">
    ...
    <div class="form-group {{ $errors->has('naturalidade_uf') ? 'has-error' : '' }}">
        <label for="naturalidade_uf" class="col-md-2 control-label">Naturalidade UF</label>
        <div class="col-md-10">
    ...
    <div class="form-group {{ $errors->has('data_nascimento') ? 'has-error' : '' }}">
        <label for="data_nascimento" class="col-md-2 control-label">Data Nascimento</label>
        <div class="col-md-10">
    ...
    <div class="form-group {{ $errors->has('nome_empresa') ? 'has-error' : '' }}">
        <label for="conjugue" class="col-md-2 control-label">Nome Cojugue</label>
        <div class="col-md-10">
    ...
    <div class="form-group {{ $errors->has('conjugue_cpf') ? 'has-error' : '' }}">
        <label for="conjugue_cpf" class="col-md-2 control-label">CPF Cojugue</label>
        <div class="col-md-10">
