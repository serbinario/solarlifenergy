...
<!-- BEGIN HORIZONTAL FORM -->
    <div class="row">
        <div class="col-lg-12">
            <form method="POST" action="{{ route('solicitacaoEntrega.store') }}" accept-charset="UTF-8" id="create_visita_tecnica_form" name="create_visita_tecnica_form" class="form-horizontal" enctype="multipart/form-data">
                <div class="card">
                    ...
                    {{ csrf_field() }}
                    @include ('logistica/visita_tecnica.form', [ 'visitaTecnica' => null,   ])
