...
@section('content')
    ...
    <!-- BEGIN HORIZONTAL FORM -->
        <div class="row">
            <div class="col-lg-12">
                <form method="POST" action="{{ route('osInstalacao.update', $ordemServico->id) }}" accept-charset="UTF-8" id="edit_visita_tecnica_form" name="edit_visita_tecnica_form" class="form-horizontal" enctype="multipart/form-data">
                    <input name="_method" type="hidden" value="PUT">
                    {{ csrf_field() }}
                    <div class="card">
                        <div class="card-head style-primary">
                            <header>Editar OS. Instalação</header>
                            <div class="tools">
                                <div class="btn-group">
                        ...
                        @include ('execucao.os_instalacao.form', ['ordemServico' => $ordemServico, ])
