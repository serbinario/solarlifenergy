...
<div class="modal fade" id="formModalDespesa" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form name="modalDespesa" class="form">
                <div class="card-body floating-label">
                    ...
                    <div id="repeat-despesa" class="row lancamentos-repeat">
                    ...
                    <div id="note-despesa" class="form-group lancamentos-note">
                    ...
                    <div class="form-group receita-tags">
                        <div>
                            <button id="btn-repeat-despesa" type="button" class="btn ink-reaction btn-floating-action btn-primary"><i class="fa fa-repeat"></i></button>
                            <label  for="textarea1">Repetir</label>
                        </div>
                        <div>
                            <button id="btn-note-despesa" type="button" class="btn ink-reaction btn-floating-action btn-primary"><i class="fa fa-comments-o"></i></button>
