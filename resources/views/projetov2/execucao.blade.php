<div class="row">
    <div class="col-md-12"> <!-- Início do col-md-12 -->
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="form-group">
                    <label for="solicitacao_acesso" class="col-sm-8 control-label text-bold">Solici. Acesso Aprovado?.:</label>
                    <div class="col-md-4">
                        <div class="checkbox checkbox-styled">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <textarea class="form-control input-sm" name="obs_execurcao" cols="50" rows="10" id="obs_execurcao" >{{ old('obs_execurcao', isset($projetov2->ProjetosExecurcao->obs_execurcao) ? $projetov2->ProjetosExecurcao->obs_execurcao : null) }}</textarea>
