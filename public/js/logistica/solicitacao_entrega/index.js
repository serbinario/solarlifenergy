$(document).ready(function () {
    ...
    var table = $('#solicitacao_entrega').DataTable({
        "dom": 'lCfrtip',
        "order": [],
        "colVis": {
            "buttonText": "Colunas",
        ...
        columns: [
            ...
            {data: 'codigo', name: 'pre.codigo', visible: true},
            {data: 'nome', name: 'cl.nome', visible: true},
            {data: 'preco_medio_instalado', name: 'pre.preco_medio_instalado', "render": function (data) { return formatMoney(data) }},
            {data: 'descricao', name: 'status.descricao'},
